	...
	if verbose:
	   ...
	   print indent + "FIRST PARTIAL EVALUATION"
        ...
        if runIupred:
          ...
          tool_functions.iupred(sequence, positionScores, config_params, inputsPath,outputsPath,verbose,detailed_output)
        ...
        if runAnchor:
          ...
          tool_functions.anchor(sequence, positionScores,anchorThreshold,inputsPath,outputsPath,verbose,detailed_output)
        ...
        if runElm:
          ...
          tool_functions.elmSearch(sequence,positionScores, outputsPath,verbose,detailed_output)
        ...
        if evaluateNetCharge:
          ...
          tool_functions.chargedSearch(sequence,positionScores, verbose)
          if stepByStep:
            raw_input(indent + "Hit enter to continue with next evaluation")
          if detailed_output:
                detailedOutFile.write('\n\n***********\n\n' )
        ...
        if runPasta:
          ...
          tool_functions.pastaSearch(sequence,pastaThreshold,inputsPath, positionScores,verbose,detailed_output)
        ...
        if runProsite:
          ...
          tool_functions.prositeSearch(sequence,positionScores, inputsPath,verbose,detailed_output)
        ...
        if runLimbo:
          ...
          if (len(sequence) > 11):
            tool_functions.limboEval(sequence,positionScores,inputsPath,outputsPath,verbose,detailed_output)
        ...
        if runTmhmm:
          ...
          tool_functions.tmhmmEval(sequence,positionScores,inputsPath,outputsPath,verbose,detailed_output)
        ...
        if runAmyloidPattern:
          ...
          tool_functions.amyloidPatternSearch(sequence,positionScores,inputsPath,outputsPath,verbose,detailed_output)
        ...
        if runWaltz:
          ...
          tool_functions.waltzSearch(sequence,positionScores,waltzThreshold,inputsPath,outputsPath,verbose,detailed_output)
        ...
        if runTango:
          ...
          tool_functions.tangoSearch(sequence,positionScores,tangoThreshold ,inputsPath,outputsPath,verbose,detailed_output)
