...
def firstPartialEvaluation(sequence, positionScores, verbose):
	...
	#blastIt(sequence,positionScores,database, verbose)
	  ...
	  tool_functions.iupred(sequence, positionScores, iupredThreshold, inputsPath,outputsPath,verbose,detailed_output)
	...
	if runProsite:
	  ...
	  tool_functions.prositeSearch(sequence,positionScores, verbose)
	...
	if runLimbo:
	  ...
	  if (len(sequence) > 11):
	    tool_functions.limboEval(sequence,positionScores, verbose)
	...
	if runTmhmm:
	  ...
	  tool_functions.tmhmmEval(sequence,positionScores, verbose)
	...
	if runAmyloidPattern:
	  ...
	  tool_functions.amyloidPatternSearch(sequence,positionScores, verbose)
	...
	if runWaltz:
	  ...
	  tool_functions.waltzSearch(sequence,positionScores, verbose)
	...
	if runTango:
	  ...
	  tool_functions.tangoSearch(sequence,positionScores, verbose)
